...
describe('You should be able to create a new board and display it', () => {
  ...
  describe('testing functionality of the displayShipUp function', () => {
    it('should return falsy when trying to place a ship in a position that it wont fit', () => {
      const jamesBoard = new gameBoard.Normal();
      const test = help.displayShipUp('B3', 'u', jamesBoard.size, 5);
